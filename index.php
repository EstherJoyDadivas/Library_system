...
<body>
    ...
    <section class="bg-image" style="background-image: url('images/library1.jpg'); height: 100vh">
                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="images/library.jpg" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                            </div>
